(function() {
    ...
    function getProducts() {
        ...
        if (isHe) {
                        return [
                { name:"קרם תה ירוק", price:126 },
                { name:"שמן חוחובה אורגני", price:142 },
                { name:"סרום פילינג חומצות", price:106 },
                { name:"סרום עיניים קולגן", price:189 },
                { name:"מדבקות אקנה", price:112 },
                { name:"סרום ספריי ראשון", price:90 },
                { name:"סרום מבהיר ויטמין C", price:95 },
                { name:"סרום קולגן מחייה", price:38 },
                { name:"משחת אקנה גופרית", price:27 },
                { name:"תמיסת פילינג חומצה סליצילית", price:54 },
                { name:"סרום ויטמין C 20%", price:123 },
                { name:"אמפולת סנטלה מרגיעה", price:59 },
                { name:"סרום רטינול מתיחה", price:59 },
                { name:"סרום מבהיר ניאצינמיד 10%", price:100 },
                { name:"תמצית שבלול 96% לחות", price:61 },
                { name:"סרום פפטידים מרובה", price:38 },
                { name:"סרום חומצה היאלורונית", price:104 },
                { name:"סרום ויטמין C מבהיר", price:38 },
                { name:"קרם סרום פיקנוגנול", price:30 },
            ];
        }
                    return [
                { name:"Green Tea Skin Cream", price:126 },
                { name:"Organic Jojoba Oil", price:142 },
                { name:"Glycolic + Lactic Acid Serum", price:106 },
                { name:"Vegan Collagen Eye Serum", price:189 },
                { name:"Overnight Spot Patches", price:112 },
                { name:"First Spray Serum", price:90 },
                { name:"Glow Filter Serum", price:95 },
                { name:"Collagen Serum", price:38 },
                { name:"Sulfur Ointment", price:27 },
                { name:"Clarifying Exfoliant", price:54 },
                { name:"Vitamin C 20% Serum", price:123 },
                { name:"Centella Ampoule", price:59 },
                { name:"Retinol Shot", price:59 },
                { name:"Niacinamide 10 Serum", price:100 },
                { name:"Snail Mucin Essence", price:61 },
                { name:"Multi-Peptide Serum", price:38 },
                { name:"Hyaluronic Acid Serum", price:104 },
                { name:"Vitamin C Classic", price:38 },
                { name:"Pycnogenol Cream", price:30 },
            ];
    }
